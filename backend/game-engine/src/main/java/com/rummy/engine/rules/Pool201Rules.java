...
/**
 * Section R18: 13-Card Pool 201 Rummy (POOL_201).
 * Players accumulate points across deals until reaching 201 (elimination).
 * First drop = 25, Middle drop = 50, Wrong declare / Full count = 80.
 */
public final class Pool201Rules implements RummyRules {

    public static final String RULESET_ID = "POOL_201";
    public static final String RULESET_VERSION = "1.0.0";
    public static final int ELIMINATION_THRESHOLD = 201;
    ...
    public Pool201Rules(int firstDropPenalty,
